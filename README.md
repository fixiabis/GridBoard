...
Can be used for &lt;script&gt; by this link: https://unpkg.com/gridboard@4.0.2/dist/gridboard.js
...
```javascript
require(["https://unpkg.com/gridboard@4.0.2/dist/gridboard"], function (gridboard) {
...
```html
<script src="https://unpkg.com/gridboard@4.0.2/dist/gridboard.js"></script>
```
