...
Can be used for &lt;script&gt; by this link: https://unpkg.com/gridboard@4.1.1/dist/gridboard.js  
or minified version: https://unpkg.com/gridboard@4.1.1/dist/gridboard.min.js
...
```javascript
require(["https://unpkg.com/gridboard@4.1.1/dist/gridboard"], function (gridboard) {
...
```html
<script src="https://unpkg.com/gridboard@4.1.1/dist/gridboard.js"></script>
```
